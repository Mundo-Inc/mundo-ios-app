//
//  UserProfileActivitiesView.swift
//  PhantomPhood
//
...
struct UserProfileActivitiesView: View {
    ...
    var body: some View {
        Group {
            if #available(iOS 17.0, *) {
                UserProfileActivitiesView17(selected: selected)
            } else {
                UserProfileActivitiesView16(selected: selected)
            }
        }
...
@available(iOS 17.0, *)
fileprivate struct UserProfileActivitiesView17: View {
...
fileprivate struct UserProfileActivitiesView16: View {
    @EnvironmentObject private var vm: UserProfileVM
    private let selected: String?
...
#Preview {
    UserProfileActivitiesView(vm: UserProfileVM(username: "@TheKia"), selected: nil)
}
