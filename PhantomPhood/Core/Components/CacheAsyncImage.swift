...
//  PhantomPhood
//
//  Created by Kia Abdi on 10/7/23.
//
...
#Preview {
    VStack {
        CacheAsyncImage(url: URL(string: "https://phantom-localdev.s3.us-west-1.amazonaws.com/64d29e412c509f60b768f240/images/3666139990c19d686988b14d23f68754.jpg")!) { Image in
            Image
                .resizable()
        ...
        CacheAsyncImage(url: URL(string: "https://phantom-localdev.s3.us-west-1.amazonaws.com/64d29e412c509f60b768f240/images/3666139990c19d686988b14d23f68754.jpg")!) { phase in
            switch phase {
            case .empty:
                ProgressView()
