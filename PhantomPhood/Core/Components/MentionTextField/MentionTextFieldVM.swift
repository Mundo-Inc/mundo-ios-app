...
final class MentionTextFieldVM: LoadingSections, ObservableObject {
    ...
    func handleMentionDetection(in textField: UITextField, at cursorPosition: Int) {
